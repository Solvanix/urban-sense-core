...
- [x] Audit the CReSInMed tourism-provider survey against SENSE Experience code, UX, and operating records to distinguish implemented features, internal criteria, and deferred capabilities.
...
- [x] Research and assess public GitHub and Palestinian-reference projects for four SENSE tracks: user and municipal AI assistance, authorized analyst safeguards, design-to-G-code digital fabrication, and branching story-based learning; record licenses, risks, and integration boundaries before reuse.
- [x] Audit the CReSInMed tourism survey, Entreviable reference, and verified Ard Kanaan / Abaya Al-Khair source records to define the implemented and permission-safe learning, attraction, individual-growth, and team-formation boundaries.
- [x] Build a source-safe interactive individual-growth journey with branching decisions, a clear optional team-formation route, and no fabricated courses, enrollments, partners, or credentials.
- [x] Link the tourism-provider readiness path, individual-growth journey, and future digital-fabrication workflow to their respective SENSE entry points without merging their data, roles, or operational claims.
- [x] Produce and maintain a city-by-city SENSE reality register for Akka, Haifa, Ramallah, Birzeit, Gaza, Nablus, Salfit, Rawabi, and any added locality; distinguish implemented function, verified local data, source-only context, and unbuilt scope across municipal, tourism, commerce, learning, and fabrication tracks.
...
- [ ] Build a reviewer-gated non-cash earned-points ledger in the central source, with an immutable event model, explicit reason and evidence reference, no cash conversion or external destination delivery, and no fabricated balances or beneficiaries.
- [ ] Add an independent SENSE Experience operating-readiness contract and operator checklist to the central source; keep database, OIDC, sessions, secrets, reviewer activation, retention, and data-opening approval separate from Urban-Sense.
- [ ] Surface the two new operational states in the SENSE portal as truthful readiness states, never as live financial service or opened provider directory.
- [ ] Verify the identity, history, current condition, and institutional/legal boundaries of Qalandia Institute and Jerusalem/Qalandia Airport through credible sources before creating any SENSE tourism or learning reference.
- [ ] Design and publish only a source-cited, non-partner professional-learning pathway for Qalandia that makes no claim of control, access, activity, institutional affiliation, or impact on UNRWA or any United Nations entity.
- [ ] Verify current UNRWA and United Nations humanitarian-service facts after 7 October across Gaza, the West Bank, Jordan, Syria, and Lebanon; distinguish interruptions, constraints, and continued services using dated first-party sources.
- [ ] Replace the isolated Qalandia framing with a source-cited humanitarian learning pathway about Palestinian refugees, housing, health, education, training, and institutional service continuity, without collecting beneficiary data or impersonating any United Nations operation.
- [ ] Define a SENSE community-support boundary that distinguishes UNRWA humanitarian services and beneficiary systems from independent learning, skills, source literacy, and official-referral tools; prohibit beneficiary intake, aid distribution, fundraising claims, and UN affiliation claims.
- [ ] Build a source-cited public knowledge-and-referral route for the Qalandia and refugee-services context that links only to official information and does not solicit money, enroll beneficiaries, or substitute for humanitarian operations.
- [ ] Write and publish a source-cited SENSE vision for Qalandia that treats continuity of education, public service, and refugee memory as civic commitments; distinguish a reported demolition-risk plan from an executed demolition and make no claim to represent UNRWA or control the site.
- [ ] Research and define a source-cited final-status-issues learning frame covering refugees, Jerusalem, borders, security, settlements, water, and economic relations; distinguish legal/institutional facts from analysis and political positions.
- [ ] Extend the public refugee-context route with a non-negotiation, source-cited political-science and international-relations layer that presents refugees as a final-status issue without collecting data, advocating for a party, or claiming representational authority.
- [ ] Define and enforce a United Nations / UNRWA non-interference boundary: no agents, facilities, accounts, beneficiary systems, data integrations, operational workflows, institutional branding, or claims that touch their privileges, immunities, premises, personnel, or humanitarian delivery.
- [ ] Define a source-cited life-impact map for final-status issues that connects refugees, Jerusalem, borders, security, settlements, water, and economic relations to housing, movement, health, education, work, water, family, memory, and local economic life without simulating service delivery or political representation.
- [ ] Verify Qalandia Training Centre’s historical role, operating scope, graduate claims, and geographic reach from institutional sources before publishing any numerical or regional-impact claim; separately cite documented premises-protection facts and avoid asserting unverified legal conclusions.
- [ ] Define a source-cited, non-operational facilities-protection learning frame covering continuity of education, workshops, archives, equipment, safe access, and personnel safety; prohibit surveillance, incident intake, security operations, or data systems involving UNRWA or United Nations premises, staff, or beneficiaries.
- [ ] Use the official UNRWA name and mandate consistently, and verify any annual medical-consultation figure with its year, coverage, and source before publication in the public knowledge route.
- [ ] Write a source-aware SENSE business-model justification and launch map connecting prototype development, tourism readiness, independent skills pathways, and dignity-housing standards; distinguish actual products from hypotheses and prohibit representing UNRWA, using beneficiary data, or monetizing humanitarian referrals.
- [ ] Define a SENSE information architecture covering a public source archive, restricted evidence register, separate operational databases, role boundaries, retention/deletion rules, and aggregated accessibility/impact indicators; exclude UNRWA/United Nations beneficiary or operational data.
- [ ] Rewrite and publish a single SENSE business-model justification covering prototype development, tourism readiness, community skills, dignity-housing standards, information archive, separated databases, accessibility and impact indicators; distinguish verified assets from hypotheses and gate every partner, financial, land, humanitarian, or institutional claim.
- [ ] Add a consent-first distributed-knowledge archive principle that can record source metadata and approved digital narratives about lost or damaged memory items, without collecting physical artefacts, personal family records, or making preservation guarantees.
- [x] Create and maintain a single Arabic SENSE entity-creation paper that compares the functional case for an organization, network/union, or development-and-coordination center before selecting a legal form; connect verified platform assets, prototype development, tourism readiness, community skills, dignity-housing standards, source archive, separated data, accessibility, impact indicators, operating boundaries, and launch decisions.
- [x] Update the SENSE entity-creation paper with a source-cited international-legitimacy and civic-institution section that treats international law and institutions as an accountability framework, not a mandate or representation claim for SENSE.
- [x] Add a symbolic-proportionality section to the SENSE entity-creation paper linking place, access, learning continuity, service dignity, and memory to concrete programs and indicators while prohibiting broad representational claims.
- [ ] Add a multi-stakeholder governance section to the SENSE entity-creation paper distinguishing official authorization, political and community dialogue, and international accountability from any claim that SENSE represents, negotiates for, or substitutes for formal leadership, political forces, or the international community.
- [x] Audit and publish a repository-and-portal reality map that lists every central application, public page, entry link, execution state, and unresolved integration gap without presenting documents or gated prototypes as finished products.
- [x] Update the GitHub Pages entry page to link the current live SENSE routes and their source or readiness state, including citizen reporting, growth, earned-value model, refugee context, project register, and the gated provider path.
- [x] Update the SENSE entity-creation paper and its companion governance report with an evidence-bounded institutional rationale, decision rights, participation limits, and a practical operating model for the proposed development-and-coordination center.
- [x] Add a relationship-and-authorization register that distinguishes official authorization, written partner agreement, consultation, public source, unverified claim, and blocked status; prohibit calling any relationship a partnership without a written agreement.
- [x] Verify and record dated institutional sources before publishing any claim about Jenin, Tulkarm, Nur Shams, displacement, population totals, facility access, or operational restrictions; retain unsupported figures only as unverified claims and exclude them from public assertions.
- [x] Add a non-interference governance annex covering UN/UNRWA relations, mandates, premises, staff, privileges and immunities, humanitarian delivery, branding, data, and operational boundaries without creating a UN-facing workflow.
- [x] Extend the entity-creation paper and governance report with evidence-bounded regional context scenes for the West Bank, Gaza, and Madaba, framing each as a research and policy lens rather than a claimed SENSE presence, office, campaign, or partnership.
- [x] Add a policy-and-strategic-studies method that separates verified fact, open question, analysis, stakeholder position, and prohibited operational claim before any regional scenario is used in SENSE decisions or public interfaces.
- [x] Produce two standalone Arabic shareable files: an entity-creation rationale paper and an institutional/strategic governance report, each with an executive decision message, evidence status, structural/legal options, and explicit limits on authorization and representation.
- [x] Produce a decision-ready 30/60/90-day operating plan for the proposed SENSE development-and-coordination center, with owners, concrete outputs, decision gates, and stopping conditions.
- [x] Draft a review-only written collaboration and community-participation agreement aligned with the relationship-and-authorization register, covering scope, consent, data, attribution, decision rights, conflicts, public communications, suspension, and termination.
- [x] Create a team decision slide deck summarizing the entity-creation rationale, institutional/strategic report, authorization boundaries, operating plan, and founder decisions without presenting the proposed center as registered or operationally authorized.
- [x] Present the complete SENSE decision-package contents in a readable in-interface sequence while retaining the source files as the authoritative full versions.
- [x] Rebuild the complete SENSE decision package around an evidence-bounded independent civic-continuity model responding to documented institutional erosion, closures, displacement, and demolition risks without claiming that UNRWA has wholly ceased operations or replacing its mandate.
- [x] Update the operating plan, collaboration draft, relationship register, and team deck so community continuity work is limited to source literacy, skills, accessible local coordination, memory/knowledge preservation, and formal referral links—not humanitarian intake, aid delivery, beneficiary data, or UN/UNRWA operational substitution.
- [x] Produce a clear, formal Arabic Word brief for competencies and initiators that leads with SENSE’s practical programs, participation opportunities, projects, partnership pathway, and call to action; place governance boundaries in a concise final section.
- [x] Produce a clear, formal Arabic PowerPoint presentation for competencies and initiators that leads with the SENSE mission, opportunity areas, project portfolio, ways to contribute, and next steps.
