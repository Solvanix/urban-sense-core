...
describe("GitHub Pages public index", () => {
  it("links static visitors to the live SENSE routes rather than unsupported local query routes", () => {
    ...
    expect(indexHtml).toContain('href="https://urbansense-dzfbcdz5.manus.space/?view=work-compass"');
    expect(indexHtml).toContain('href="https://urbansense-dzfbcdz5.manus.space/?view=continuity"');
