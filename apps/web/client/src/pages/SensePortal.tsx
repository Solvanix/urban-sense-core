...
import { ecosystemExplorerHref, experienceHubHref, growthJourneyHref, independencePathHref, liveVisualizeHref, loyaltyExplainerHref, masakenAlKhairHref, municipalOperationsHref, nationalContinuityHref, refugeeContextHref, tourismPlatformHref, urbanSenseHref, verificationRoomHref, workCompassHref } from "@/lib/sensePortalRoute";
import { Accessibility, ArrowLeft, BadgeCheck, BarChart3, Bot, Building2, BriefcaseBusiness, ChevronLeft, CircleDollarSign, ClipboardList, Code2, Compass, Database, Eye, Gauge, Landmark, Layers3, LockKeyhole, Map, MessageCircle, Radio, Route, ShieldCheck, Store, UserRoundCheck, UsersRound, Wrench } from "lucide-react";
...
export const ecosystemRoutes: EcosystemRoute[] = [
  ...
  { id: "verification-room", label: "غرفة التحقق", eyebrow: "خبر · مصدر · دليل", readiness: "منشور", description: "مساحة أولية لتحويل المعلومة الخام إلى بطاقة مراجعة قبل التفكير في النشر.", detail: "المسودات محلية وغير منشورة؛ الربط الخادمي والمراجعة متعددة الأدوار مرحلة لاحقة.", actionLabel: "افتح غرفة التحقق", href: verificationRoomHref, internal: true, icon: ShieldCheck, tone: "slate" },
  { id: "experience", label: "SENSE Experience", eyebrow: "مكان · مسار · أثر", readiness: "نواة مستقلة", description: "صفحات مترابطة لمسار التجارب والمزوّد والمراجعة البشرية ضمن حدود تشغيل صادقة.", detail: "تتوفر أدوات الاستديو والوصول ومسودة الادعاء محليًا؛ بيانات المزودين الحقيقية وAPI المستقلة ما زالت مقفلة حتى الجاهزية.", actionLabel: "افتح مشروع SENSE Experience", href: experienceHubHref, internal: true, icon: Map, tone: "blue" },
  { id: "tourism", label: "منصة السياحة", eyebrow: "اكتشاف · مسار · خطة يوم", readiness: "نواة مستقلة", description: "دليل تفاعلي لاكتشاف مسارات المكان وبناء خطة زيارة قابلة للطباعة مع حدود المصدر والوصول واضحة.", detail: "تعمل الآن ببطاقات تجريبية للعيزرية؛ لا حجوزات أو أسعار أو أوقات فتح حية قبل اعتماد مصادر وشركاء تشغيل.", actionLabel: "افتح منصة السياحة", href: tourismPlatformHref, internal: true, icon: Compass, tone: "amber" },
  { id: "independence", label: "مسار الاستقلال", eyebrow: "حركة · دراسة · عمل · إبداع · سكن", readiness: "منشور", description: "أداة شخصية تحوّل هدفك إلى خطوات قابلة للتعديل والمتابعة والطباعة على جهازك.", detail: "لا تطلب تشخيصًا ولا حسابًا ولا ترسل خطتك لأي جهة؛ لا تحجز نقلًا أو سكنًا ولا تقدم وعدًا بخدمة ميدانية.", actionLabel: "ابدأ خطتي الشخصية", href: independencePathHref, internal: true, icon: Accessibility, tone: "teal" },
  ...
  { id: "work-compass", label: "بوصلة العمل", eyebrow: "حاجة · ذكاء اصطناعي · تحقق", readiness: "منشور", description: "ميزة تفاعلية تحوّل الحاجة إلى بطاقة عمل: دور للأداة، تدقيق، ومخرج يمكن مشاركته مع مراجع أو فريق.", detail: "لا تجمع أسماء أو محادثات أو بيانات شخصية؛ البطاقة تبقى عند المستخدم حتى يقرر نسخها أو مشاركتها.", actionLabel: "ابنِ بطاقة عمل", href: workCompassHref, internal: true, icon: Bot, tone: "blue" },
  ...
  { id: "refugees", label: "سياق اللاجئين والخدمات", eyebrow: "مصادر · إحالة · مهارات مستقلة", readiness: "منشور", description: "مسار معرفة عن استمرارية الخدمات وقيودها ودور المجتمع في التعلم والإحالة السليمة.", detail: "ليس تسجيل مساعدات أو تبرعًا أو تمثيلًا للأونروا؛ يعرض مصادر رسمية مؤرخة وحدود الدور المستقل.", actionLabel: "افتح سياق المعرفة", href: refugeeContextHref, internal: true, icon: Landmark, tone: "teal" },
  { id: "continuity", label: "الاستمرارية الوطنية", eyebrow: "مهارة · إتاحة · ذاكرة · مشروع", readiness: "منشور", description: "مسار تفاعلي يبني مخرجًا مدنيًا صغيرًا من قدرة محلية: معرفة أو مهارة أو إتاحة أو ذاكرة أو مشروع.", detail: "يربط قلنديا وسياق الخدمات بالمصادر العامة المؤرخة، ويحوّلها إلى أسئلة بناء ومخارج محلية لا إلى ادعاء تفويض أو خدمة إنسانية.", actionLabel: "ابدأ مسار الاستمرارية", href: nationalContinuityHref, internal: true, icon: Landmark, tone: "teal" },
  { id: "live-visualize", label: "Visualize التشغيلي", eyebrow: "قاعدة بيانات · مؤشرات · قرار", readiness: "منشور", description: "لوحة تفاعلية تقرأ مؤشرات البلاغات الفعلية من قاعدة Urban‑Sense ضمن صلاحيات البلدية.", detail: "لا تعرض بيانات المواطنين الخام؛ تجمع الحالات والتصنيفات وزمن الإغلاق وتحدث القراءة تلقائياً بعد الدخول المحمي.", actionLabel: "افتح اللوحة التشغيلية", href: liveVisualizeHref, internal: true, icon: BarChart3, tone: "blue" },
...
export const ecosystemAccessGates: EcosystemAccessGate[] = [
  ...
  { id: "independence", label: "شخص يخطط لاستقلاله", status: "متاح بلا حساب", description: "ينشئ خطة شخصية للحركة أو الدراسة أو العمل أو الإبداع أو السكن؛ تُحفظ محليًا فقط.", action: "افتح مسار الاستقلال", href: independencePathHref, internal: true, icon: Accessibility, tone: "teal" },
  { id: "earner", label: "مروج أو مزود", status: "نموذج استحقاق مقيد", description: "يتعرف على النقاط والقسائم؛ لا يربط هاتفه ولا يتلقى رصيدًا أو دفعة عبر المنصة الآن.", action: "افهم الاستحقاق", href: loyaltyExplainerHref, internal: true, icon: BadgeCheck, tone: "blue" },
