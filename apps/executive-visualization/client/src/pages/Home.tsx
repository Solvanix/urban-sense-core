      ...
      <nav className="sticky top-0 z-40 border-b border-white/10 bg-[#071216]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-5 py-4 lg:px-8">
          ...
          <div className="hidden items-center gap-7 text-xs font-black text-white/55 md:flex">
            ...
            <button onClick={() => scrollTo("traffic")} className="transition hover:text-white">المختبر المروري</button><button onClick={() => scrollTo("formats")} className="transition hover:text-white">الأشكال</button>
