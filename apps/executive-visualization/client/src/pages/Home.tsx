  ...
  return (
    <main dir="rtl" className="min-h-screen overflow-hidden bg-[#071216] text-[#f7f8f1]">
      ...
      <nav className="sticky top-0 z-40 border-b border-white/10 bg-[#071216]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-5 py-4 lg:px-8">
          ...
          <div className="hidden items-center gap-7 text-xs font-black text-white/55 md:flex">
            ...
            <button onClick={() => scrollTo("traffic")} className="transition hover:text-white">المختبر المروري</button><button onClick={() => scrollTo("validation")} className="transition hover:text-white">بوابة التحقق</button><button onClick={() => scrollTo("formats")} className="transition hover:text-white">الأشكال</button>
        ...
        {menuOpen && <div className="border-t border-white/10 px-5 py-3 md:hidden"><div className="flex flex-wrap gap-4 text-xs font-black text-white/70"><button onClick={() => scrollTo("desk")}>غرفة الأخبار</button><button onClick={() => scrollTo("stories")}>القصص</button><button onClick={() => scrollTo("traffic")}>المختبر المروري</button><button onClick={() => scrollTo("validation")}>بوابة التحقق</button><button onClick={() => scrollTo("formats")}>الأشكال</button><button onClick={() => scrollTo("brief")}>بطاقة التغطية</button></div></div>}
      </nav>
      ...
      <div id="top" className="relative mx-auto max-w-7xl px-5 pb-20 pt-16 lg:px-8 lg:pt-24">
        ...
        <section id="traffic" className="scroll-mt-24 pt-24"><div className="section-heading"><div><p className="eyebrow text-emerald-300"><CarFront size={14} /> Mobility Lab / 03</p><h2 className="section-title">المختبر المروري</h2><p className="section-copy">نحوّل معرفة إدارة الحركة وهندسة المرور إلى صحافة مكانية: خبر يخدم السائق، تقرير يشرح الاختناق، وخريطة تساعد الزائر على الوصول.</p></div><span className="studio-tag">المكان + الحركة + الأثر</span></div><div className="mt-8 grid gap-3 lg:grid-cols-[1.1fr_.9fr]"><div className="traffic-dashboard"><div className="flex items-center justify-between"><span className="text-xs font-black text-emerald-200">قراءة تشغيلية تجريبية</span><Activity size={19} className="text-[#f7cc71]" /></div><div className="mt-8 grid grid-cols-3 gap-2 text-center"><div><b className="block text-3xl font-black text-[#f7cc71]">B</b><span>مستوى الخدمة</span></div><div><b className="block text-3xl font-black text-emerald-300">18</b><span>دقيقة تأخير</span></div><div><b className="block text-3xl font-black text-sky-300">02</b><span>مواقف بديلة</span></div></div><div className="mt-8 rounded-2xl border border-white/10 bg-black/15 p-4"><p className="text-[10px] font-black text-white/35">نموذج خبر خدمي</p><p className="mt-2 text-sm font-black leading-7 text-white/80">تأخير مروري على طريق العيزرية–القدس بسبب أعمال تنظيم مؤقتة</p><p className="mt-2 text-xs leading-6 text-white/45">يحتاج إلى وقت الرصد، مصدر الجهة المشغلة، ومسار بديل قبل النشر.</p></div></div><div className="grid gap-3 sm:grid-cols-2"><article className="method-card"><ParkingCircle size={20} /><h3>المواقف</h3><p>نرصد السعة، الطلب، الوصول والبدائل بدل أن نكتفي بعبارة «لا يوجد موقف».</p></article><article className="method-card"><Activity size={20} /><h3>التدفق والازدحام</h3><p>نشرح أين يبدأ الاختناق، متى يتكرر، وما أثره على الزائر وأهل المكان.</p></article><article className="method-card"><MapPinned size={20} /><h3>خطة الحركة</h3><p>نحوّل التحويلات المؤقتة إلى خريطة وخبر قصير قابل للتحديث.</p></article><article className="method-card"><ShieldCheck size={20} /><h3>دراسة الأثر</h3><p>نسأل ماذا سيحدث للطريق والمواقف والمشاة قبل الترويج لمشروع سياحي.</p></article></div></div></section>

        <section id="validation" className="scroll-mt-24 pt-24"><div className="section-heading"><div><p className="eyebrow text-amber-200"><ShieldCheck size={14} /> UrbanUp Gate / 04</p><h2 className="section-title">بوابة التحقق قبل التوسع</h2><p className="section-copy">لا يكفي أن تعمل الواجهة. نختبر المشكلة، وسير العمل، والمالك التشغيلي، وكلفة الخطأ قبل تثبيت أي تكامل أو ادعاء.</p></div><span className="studio-tag">الدليل قبل المعمارية</span></div><div className="mt-8 grid gap-3 lg:grid-cols-[1.05fr_.95fr]"><div className="decision-panel"><div className="flex items-center justify-between"><span className="story-type gold">قرار حالي</span><CircleAlert size={20} className="text-[#f7cc71]" /></div><h3 className="mt-5 text-2xl font-black leading-tight">نواة SENSE قابلة للاختبار، والمنصة البلدية ليست مثبتة بعد</h3><p className="mt-4 text-sm leading-8 text-white/60">النواة المعتمدة الآن هي بطاقة التغطية، سجل الدليل، التصنيف التحريري، المراجعة البشرية، والنشر. تبقى الأرقام المرورية والواجهات التشغيلية تجريبية حتى تُربط بقياس ومصدر وزمن.</p><div className="mt-6 grid gap-2">{[["G1", "دليل المشكلة", "أصفر"], ["G2", "الوظيفة الأساسية", "أخضر مبدئي"], ["G3", "ظروف الميدان", "أحمر جزئي"], ["G4", "المالك التشغيلي", "أحمر"]].map(([gate, label, state]) => <div key={gate} className="flex items-center justify-between rounded-xl border border-white/10 bg-black/15 px-4 py-3 text-xs"><span className="font-black text-white/75">{gate} · {label}</span><span className="font-black text-[#f7cc71]">{state}</span></div>)}</div></div><div className="grid gap-3 sm:grid-cols-2"><article className="method-card"><CircleAlert size={20} /><h3>اختبر الفشل</h3><p>اسأل عن آخر واقعة فشل حقيقية، وتكرارها، وما الذي حدث بعدها، بدل سؤال «هل تعجبك المنصة؟».</p></article><article className="method-card"><Activity size={20} /><h3>قِس قبل الادعاء</h3><p>كل خبر مروري يحتاج وقت رصد ومصدرًا وحدودًا. واجهة تعمل على جهاز الفريق ليست بيانات ميدانية.</p></article><article className="method-card"><ShieldCheck size={20} /><h3>صمّم مسار التعطل</h3><p>عند انقطاع الاتصال أو غموض المصدر أو تعارض الأرقام، تتوقف المادة أو تعود للمراجعة البشرية.</p></article><article className="method-card"><Check size={20} /><h3>قرار قابل للتراجع</h3><p>نوسع بعد خمس مواد متتالية قابلة للمراجعة، ونعيد التصميم إذا فشلت ثلاث حالات في التحقق.</p></article></div></div></section>
