...
export const demoVisitSignals: VisitSignal[] = [
  ...
  },
  {
    ...
    note: "يتحدث النص عن بيت أونيا، بيت أثري مرمم في بيتونيا، وجولة ضمن مهرجان «يلا على بيتونيا». لا يتضمن النص تاريخ الفعالية أو تفاصيل تشغيلية؛ لذلك لا يظهر كمسار جاهز في العيزرية، ويحتاج بطاقة مستقلة ضمن عدسة فلسطين.",
  },
  {
    id: "accessibility",
    label: "الوصولية",
