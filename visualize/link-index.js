...
const statusLabel = {published:"منشورة", "verified-public":"عامة ومتحقق منها", public:"عامة", temporary:"مؤقتة", "public-reference":"مرجع عام", "login-required":"تتطلب دخولاً", "login-or-session-dependent":"جلسة أو دخول"};
function badgeClass(status){ if(status.includes("temporary")) return "temporary"; if(status.includes("reference")) return "reference"; if(status.includes("login")) return "restricted"; return ""; }
