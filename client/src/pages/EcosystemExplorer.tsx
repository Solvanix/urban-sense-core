      ...
      <div className="mx-auto max-w-7xl px-5 pb-16 pt-5 lg:px-8">
        ...
        <section className="grid gap-8 py-12 lg:grid-cols-[1.05fr_.95fr] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-white/65">هذه ليست صفحة تسويقية تُخفي الفجوات. إنها مدخل بصري واحد: يبيّن التطبيق المنشور، الكود المستقل، والمسارات المقترحة التي تحتاج قرارًا وتشغيلًا.</p>
          </div>
