...
export default function ReportDetail() {
  ...
  const reportQuery = trpc.reports.getById.useQuery({ reportId }, { enabled: isAuthenticated && Number.isFinite(reportId), retry: false });
  ...
  if (reportQuery.isPending && !reportQuery.error) return <div className="grid min-h-screen place-items-center"><Loader2 className="animate-spin text-[#0f5b5b]" /></div>;
