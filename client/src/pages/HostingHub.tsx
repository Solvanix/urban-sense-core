...
export default function HostingHub() {
  ...
  const submitInterest = () => {
    setNotice(interest ? "حُفظ اختيارك داخل هذه المعاينة فقط. لا أُرسل بياناتك ولا أفتح حجزًا أو التزامًا." : "اختر نوع المشاركة أولًا؛ النموذج لا يرسل بيانات خارجية.");
  };
