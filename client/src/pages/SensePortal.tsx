...
import { hostingHubHref } from "@/lib/sensePortalRoute";
import { ecosystemExplorerHref, growthJourneyHref, loyaltyExplainerHref, municipalOperationsHref, nationalContinuityHref, recoveryIdentityHref, refugeeContextHref, urbanSenseHref, workCompassHref } from "@/lib/sensePortalRoute";
import { Accessibility, ArrowLeft, BadgeCheck, Bot, Building2, BriefcaseBusiness, ChevronLeft, CircleDollarSign, ClipboardList, Code2, Compass, Database, Eye, Gauge, Handshake, Landmark, Layers3, LockKeyhole, Map, MessageCircle, Radio, Route, ShieldCheck, Store, Tag, UserRoundCheck, UsersRound, Wrench } from "lucide-react";
...
export const ecosystemRoutes: EcosystemRoute[] = [
  ...
  { id: "hosting", label: "الاستضافة المجتمعية", eyebrow: "مضيف · مستضاف · برنامج", readiness: "منشور", description: "مسار متكامل للجلوس والعمل والاجتماعات والأنشطة والولاء المتبادل مع حدود واضحة.", detail: "صفحة مدخلية تشرح المضيفين والمستضافين والبرامج والرعاية ومبادرات الطلاب دون حجز أو دفع أو إعلان شواغر غير مؤكدة.", actionLabel: "افتح مسار الاستضافة", href: hostingHubHref, internal: true, icon: Handshake, tone: "teal" },
  { id: "recovery-identity", label: "هوية المنتج والاسترداد", eyebrow: "NFC · أصالة · مرور", readiness: "منشور", description: "طبقة فعلية لوسم المنتج أو الغرض، عرض قصته ومصدره، وفتح مسار استرداد يحمي خصوصية المالك.", detail: "تبدأ بصفحة هوية ورابط قابل للقراءة عبر NFC، ثم تتوسع إلى سجل أحداث ومتابعة مزود أو بلدية بصلاحيات منفصلة.", actionLabel: "افتح هوية المنتج", href: recoveryIdentityHref, internal: true, icon: Tag, tone: "blue" },
