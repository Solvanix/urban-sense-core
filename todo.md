...
- [ ] إعداد ملف رسمي لجهة الإنتاج يتضمن مقترحات بودكاست وفيديو ومقالة باسم SENSE team.
- [ ] تحديد كيفية استثمار حفل Palestine Launchpad with Google في اللقطات والسياق دون ادعاء شراكة.
- [ ] تحديد المواد والموافقات المطلوبة قبل الحفل وأثناءه وبعده.
- [ ] صياغة سؤال مباشر لمدير الجهة حول إمكانية استثمار الحفل في الإنتاج.
